	...
	["chunk-540e805e"], {
		...
		5362: function(t, s, i) {
			...
			var e = function() {
				...
				o = {
					...
					computed: Object(n["a"])({}, Object(a["c"])(["playing", "currentMusic"])),
					watch: {
						list: function(t, s) {
		...
		"5af1": function(t, s, i) {
			...
			var e = function() {
				...
				a = n,
				c = (i("9673"), i("2877")),
				r = Object(c["a"])(a, e, l, !1, null, null, null);
			s["a"] = r.exports
		},
		7786: function(t, s, i) {
			"use strict";
		...
		8184: function(t, s, i) {
			...
			var e = function() {
				...
				u = {
					...
					computed: Object(a["a"])({}, Object(c["c"])(["playing", "playlist", "currentMusic"])),
					methods: Object(a["a"])(Object(a["a"])({
						clearList: function() {
							this.clearPlayList(), this.$mmToast("列表清空成功")
						},
						selectItem: function(t, s) {
							t.id !== this.currentMusic.id && (this.setCurrentIndex(s), this.setPlaying(!0))
						},
						deleteItem: function(t) {
							var s = Object(n["a"])(this.playlist);
							s.splice(t, 1), this.removerPlayListItem({
								list: s,
								index: t
							}), this.$mmToast("删除成功")
						}
					...
					})), Object(c["b"])(["removerPlayListItem", "clearPlayList"]))
				},
				m = u,
				p = (i("039c"), i("2877")),
				f = Object(p["a"])(m, e, l, !1, null, null, null);
			s["default"] = f.exports
		},
		9673: function(t, s, i) {
			"use strict";
...
//# sourceMappingURL=chunk-540e805e.eaf466fc.js.map
